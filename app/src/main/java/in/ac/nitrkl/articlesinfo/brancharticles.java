...
public class brancharticles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brancharticles);

        int id=getIntent().getIntExtra("branchid",0);
        url=url+"id="+id;
        //Toast.makeText(getApplicationContext(),url,Toast.LENGTH_SHORT).show();
        lv=(ListView)findViewById(R.id.branch_articles_list);
        getdata();
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i= new Intent(brancharticles.this,complete_article.class);
        ...
        StringRequest stringRequest = new StringRequest(url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(brancharticles.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_profile:
                Intent i=new Intent(brancharticles.this,userprofile.class);
                startActivity(i);
    ...
    public boolean onCreateOptionsMenu(Menu menus) {
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String arg0) {
                Intent i=new Intent(brancharticles.this,searcharticles.class);
