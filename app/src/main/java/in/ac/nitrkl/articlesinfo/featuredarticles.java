...
public class featuredarticles extends AppCompatActivity {
    ListView lv;
    int ids[];
    parsejson pjson;
    final String url = "http://192.168.43.68/articleinfo/featuredarticles.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_featuredarticles);

        lv=(ListView)findViewById(R.id.featuredlist);
        getdata();
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i= new Intent(featuredarticles.this,complete_article.class);
        ...
        StringRequest stringRequest = new StringRequest(url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(featuredarticles.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_profile:
                Intent i=new Intent(featuredarticles.this,userprofile.class);
                startActivity(i);
    ...
    public boolean onCreateOptionsMenu(Menu menus) {
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String arg0) {
                Intent i=new Intent(featuredarticles.this,searcharticles.class);
