...
public class ourrecentarticles extends AppCompatActivity {
    String receiveddata;
    ListView lv;
    int ids[];
    parsejson pjson;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ourrecentarticles);
        lv=(ListView)findViewById(R.id.recentlist);
        getdata();
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i= new Intent(ourrecentarticles.this,complete_article.class);
        ...
        StringRequest stringRequest = new StringRequest(url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ourrecentarticles.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_profile:
                Intent i=new Intent(ourrecentarticles.this,userprofile.class);
                startActivity(i);
    ...
    public boolean onCreateOptionsMenu(Menu menus) {
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String arg0) {
                Intent i=new Intent(ourrecentarticles.this,searcharticles.class);
