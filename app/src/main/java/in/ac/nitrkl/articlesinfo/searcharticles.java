...
public class searcharticles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String keyword= getIntent().getStringExtra("searchword");
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i= new Intent(searcharticles.this,complete_article.class);
        ...
        StringRequest stringRequest = new StringRequest(url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(searcharticles.this,error.getMessage(),Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_profile:
                Intent i=new Intent(searcharticles.this,userprofile.class);
                startActivity(i);
    ...
    public boolean onCreateOptionsMenu(Menu menus) {
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String arg0) {
                Intent i=new Intent(searcharticles.this,searcharticles.class);
